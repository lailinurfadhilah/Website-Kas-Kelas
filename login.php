  ...
  <style>
	* {
  	...
  	body {
	    ...
	    background-image: url(assets/img/img_properties/blur.jpg);
	}
...
<body>
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-4 mx-5 py-4 px-5 text-dark" style="background-color: rgba(221, 221, 221, 0.4);">
				<h3 class="text-center">KAS PTI 2021A</h3>
				<form method="post">
		...
		<div style="background-color: transparent;" class="container-fluid mt-5">
			<div class="row justify-content-center">
				<div class="col-lg text-center text-white pt-4 pb-2">
					<p>&copy; Copyright 2023. Cloud Computing PTI 2021. All Right Reserved.</p>
				</div>
			</div>
		</div>
	</footer>
